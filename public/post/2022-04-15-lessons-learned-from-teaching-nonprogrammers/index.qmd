...
After experiencing a few errors due to not using capital letters in column names, the students were more than willing to use `clean_names()` from [{janitor}](https://albert-rapp.de/post/2022-01-12-janitor-showcase/).
...
If you liked this essay, then consider following me on [Twitter](https://twitter.com/rappa753) and/or subscribing to my [RSS feed](https://albert-rapp.de/index.xml). 
See you next time!