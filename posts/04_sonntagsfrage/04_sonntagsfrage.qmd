...
[^scrape-polls]: The resulting data can be found [here](https://albert-rapp.de/posts/04_sonntagsfrage/allensbach_emnid_votes.csv) and the script I used to extract the data is [here](https://albert-rapp.de/posts/04_sonntagsfrage/web_scrape_script.R)
