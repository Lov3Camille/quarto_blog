...
That's a bit of a shame because my most popular tweet is in that timeframe.
It was about a [fun R infographic](https://twitter.com/rappa753/status/1500213701370171392).
...
If you're curious about how that works, check out my [corresponding blog post](https://albert-rapp.de/post/2022-04-11-get-twitter-posts-into-your-notetaking-system/).
...
You can read up on how that works in the "Preparations" section of the [above blog post](https://albert-rapp.de/post/2022-04-11-get-twitter-posts-into-your-notetaking-system/#preparations).
...
If that doesn't mean anything to you, let me once again refer to the [above blog post](https://albert-rapp.de/post/2022-04-11-get-twitter-posts-into-your-notetaking-system/#preparations).
...
* techniques you know from my two previous storytelling with ggplot posts (see [here](https://albert-rapp.de/post/2022-03-29-recreating-the-swd-look/) and
[here](https://albert-rapp.de/post/2022-05-01-use-grobs-to-get-rounded-corners/)) plus
* data wrangling using times and dates with the functions that I just showed you.

Once again, thank you all for your support.
And if you liked this post and don't follow my work yet, then consider following me on [Twitter](https://twitter.com/rappa753) and/or subscribing to my [RSS feed](https://albert-rapp.de/index.xml). 
See you next time!